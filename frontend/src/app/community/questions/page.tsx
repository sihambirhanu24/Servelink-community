...
import {
  ...
  Tag, Loader2, ArrowLeft, ShieldCheck, Award
} from "lucide-react";
      ...
      <main className="mt-16 lg:ml-64 h-[calc(100vh-4rem)] overflow-y-auto">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* Left/Center Main Content (2 columns on large screens) */}
                    ...
                    <article className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm hover:border-[#043658]/30 hover:shadow-md transition-all">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="mt-1 text-sm text-slate-500 line-clamp-2">{stripHtml(q.description)}</p>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between text-xs">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-100 font-bold text-slate-700">AT</span>
                      <span className="font-medium text-slate-800">Almaz Tadesse</span>
                    </div>
                    <span className="font-semibold text-slate-500">840 pts</span>
                  </div>
                  <div className="flex items-center justify-between text-xs">
                    <div className="flex items-center gap-2">
                      <span className="font-bold text-slate-400">#2</span>
                      <span className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-100 font-bold text-slate-700">DA</span>
                      <span className="font-medium text-slate-800">Dawit Alemu</span>
                    </div>
                    <span className="font-semibold text-slate-500">620 pts</span>
                  </div>
                  <div className="flex items-center justify-between text-xs">
                    <div className="flex items-center gap-2">
                      <span className="font-bold text-amber-700">#3</span>
                      <span className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-100 font-bold text-slate-700">YK</span>
                      <span className="font-medium text-slate-800">Yonas Kebede</span>
                    </div>
                    <span className="font-semibold text-slate-500">590 pts</span>
                  </div>
                </div>
              </div>
